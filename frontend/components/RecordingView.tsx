...
import { FaStop, FaUpload, FaTrash, FaPencilAlt } from 'react-icons/fa';
    ...
    >
      ...
      >
        ...
        >
              ...
              {recordingMode === 'both' ? (
                <Flex maxW="4xl" mx="auto" gap={4}>
                  ...
                  >
                    ...
                    <Text fontSize="xs" color="var(--text-muted)" pt={1}>
                      Microphone
                    </Text>
                  </Box>
                  <Box
          ...
          <Box>
            <Text fontSize="2xl" fontFamily="mono" color="var(--text-accent)">
              {recordingTime}
            </Text>

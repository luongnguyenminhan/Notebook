...
const SharesListModal: React.FC<SharesListModalProps> = ({
  isOpen,
  onClose,
  userShares,
  onDeleteShare,
  ...
  <Modal isOpen={isOpen} onClose={onClose} isCentered size="2xl">
    ...
    >
      <ModalHeader borderBottomWidth={1} borderColor="var(--border-primary)">
        ...
        <Button onClick={onClose} size="sm" variant="ghost" float="right">
          <FaTimes />
        </Button>
      </ModalHeader>
          ...
          userShares.map((share) => (
            ...
            >
              ...
              <Flex mt={4} gap={4} align="center">
                <Checkbox
                  isChecked={share.share_summary}
                  onChange={(e) =>
                    onUpdateShare({ ...share, share_summary: e.target.checked })
                  }
                  colorScheme="blue"
                >
                  Share Summary
                ...
                <Checkbox
                  isChecked={share.share_notes}
                  onChange={(e) =>
                    onUpdateShare({ ...share, share_notes: e.target.checked })
                  }
                  colorScheme="blue"
                >
                  Share Notes
